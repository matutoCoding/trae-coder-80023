...
import { Calculator, Plus, Trash2, Save, Sparkles, TrendingUp } from "lucide-react";
        ...
        <section className="p-5 rounded-2xl bg-gradient-to-br from-amber-500/10 to-orange-500/5 border border-amber-500/20">
          <div className="flex items-center gap-2 mb-4">
            ...
            <div>
              ...
              <p className="text-[11px] text-industrial-400">输入条件实时查看阶梯计价结果</p>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="space-y-2.5">
            {tiers.map((tier, idx) => {
              ...
              return (
                <div key={tier.id} className={`p-3.5 rounded-xl bg-gradient-to-br ${color} border`}>
                  <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-2 py-2 rounded-lg bg-industrial-900/60 border border-white/10 text-white text-sm text-center focus:border-primary-500 focus:outline-none"
                      />
                    </div>
                    <div>
